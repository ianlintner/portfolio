...
- **Sprites**:
  - Cat (Walk, Idle, Jump) - _Existing in `public/images/cats/`_
  - Enemies (Mouse, Dog, etc.) - _Need to source or use placeholders_
  - Tileset (Ground, Platforms) - _Need to source or use placeholders_
  - Items (Bowl, Leaf) - _Need to source or use placeholders_
