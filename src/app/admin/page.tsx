    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome back, {session?.user.name}. Here's an overview of your content.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-card text-card-foreground rounded-lg border p-6">
          ...
          <div>
            <div className="text-2xl font-bold">{postsLoading ? '...' : posts?.length || 0}</div>
        ...
        <div className="bg-card text-card-foreground rounded-lg border p-6">
          ...
          <div>
            <div className="text-2xl font-bold">{demosLoading ? '...' : demos?.length || 0}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <div className="bg-card text-card-foreground rounded-lg border p-6">
          ...
          <div>
            <div className="text-2xl font-bold">{publishedPosts.length + publishedDemos.length}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <div className="bg-card text-card-foreground rounded-lg border p-6">
          ...
          <div>
            <div className="text-2xl font-bold">{draftPosts.length + draftDemos.length}</div>
            <p className="text-xs text-muted-foreground">
              Items in draft
            </p>
          </div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Add a component demonstration</p>
              </div>
            </div>
          </a>
        </div>
