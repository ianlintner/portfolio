...
Now? We're building systems that have *goals*. It's like managing a team of junior engineers—you give them a direction, not a script. And just like managing people, it's messy.
...
- Each agent should expose metrics like _goal completion rate_, _sub-goal churn_, and _action latency_.
