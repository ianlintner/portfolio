...
export const metadata: Metadata = {
  ...
  description: 'Technical articles about modern web development, React, Next.js, TypeScript, and cloud technologies. Learn from real-world projects and best practices.',
  keywords: ['web development', 'React', 'Next.js', 'TypeScript', 'cloud computing', 'full stack development'],
  openGraph: {
    title: 'Blog | Ian Lintner - Full Stack Developer',
    description: 'Technical articles about modern web development, React, Next.js, TypeScript, and cloud technologies.',
    type: 'website',
    url: '/blog',
  },
  twitter: {
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div className="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Get notified when I publish new articles about web development and cloud technologies.
                </p>
