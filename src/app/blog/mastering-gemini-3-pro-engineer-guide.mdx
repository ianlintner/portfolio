...
Google's at it again. Gemini 3 Pro is here, and the benchmarks are wild.

But benchmarks don't ship code. I've been around long enough to know that "state-of-the-art" on a chart doesn't always mean "useful in production." So, I took it for a spin to see if it's actually useful for the daily grind or just another shiny toy.
