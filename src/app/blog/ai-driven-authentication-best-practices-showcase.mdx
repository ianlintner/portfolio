...
To demonstrate this concept, I built an [Authentication Showcase](https://auth-demo.cat-herding.net/) that implements all major authentication methods used by modern web applications:
