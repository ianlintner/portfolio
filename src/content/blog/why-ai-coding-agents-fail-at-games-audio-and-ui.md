...
author: "Ian Lintner"
image: "/images/ai-coding-limitations-social.png"
imageAlt: "Why AI Agents Fail at Games, Audio, and Complex UI"
---
...
When an AI tries to write a game loop, it knows the _syntax_ of `requestAnimationFrame`, but it doesn't understand "fun." It doesn't understand "game feel." It can't "see" that the jump physics feel floaty or that the collision detection is janky.
...
Why? Because it doesn't have eyes. It doesn't understand whitespace, visual hierarchy, or contrast in a perceptual way. It only knows the CSS rules that _usually_ go together.
