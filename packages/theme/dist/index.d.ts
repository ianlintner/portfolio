...
declare const NotificationBadge: React__default.ForwardRefExoticComponent<NotificationBadgeProps & React__default.RefAttributes<HTMLSpanElement>>;
...
type RadioProps = Omit<React__default.InputHTMLAttributes<HTMLInputElement>, "type">;
/**
 * Radio
 *
 * Styled radio button.
 ...
 */
declare function FormField({ label, htmlFor, required, description, hint, error, layout, labelAside, children, className, }: FormFieldProps): react_jsx_runtime.JSX.Element;
 ...
 */
declare function useCookieStorage<T>(key: string, initialValue: T, options?: CookieOptions): [T, (value: T | ((prev: T) => T)) => void, () => void];
 ...
 */
declare function useBreakpoint(breakpoint: "sm" | "md" | "lg" | "xl" | "2xl"): boolean;
/**
 ...
 */
declare const CODE_LANGUAGES: readonly ["typescript", "javascript", "python", "rust", "go", "java", "csharp", "cpp", "c", "ruby", "php", "swift", "kotlin", "scala", "shell", "bash", "powershell", "sql", "html", "css", "json", "yaml", "markdown", "graphql"];
 ...
 * </CodeLanguageProvider>
 */
declare function CodeLanguageProvider({ children, defaultLanguage, }: {
    children: React.ReactNode;
    defaultLanguage?: string;
}): React$1.FunctionComponentElement<React$1.ProviderProps<CodeLanguageContextValue | null>>;
/**
