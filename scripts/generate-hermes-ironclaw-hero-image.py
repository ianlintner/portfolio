...
for radius in range(80, 0, -2):
    ...
    draw.ellipse(
        ...
        fill=(0, int(brightness * 0.7), brightness),
    )

# Bright star core
draw.ellipse([cx - 14, cy - 14, cx + 14, cy + 14], fill=(120, 222, 255))
draw.ellipse([cx - 8, cy - 8, cx + 8, cy + 8], fill=(200, 248, 255))
...
# Planet 1 (cyan)
px1, py1 = 780, 220
draw.ellipse([px1 - 12, py1 - 12, px1 + 12, py1 + 12], fill="#0ea5e9")
draw.ellipse([px1 - 8, py1 - 8, px1 + 8, py1 + 8], fill="#38bdf8")

# Planet 2 (purple)
px2, py2 = 1020, 175
draw.ellipse([px2 - 9, py2 - 9, px2 + 9, py2 + 9], fill="#8b5cf6")
draw.ellipse([px2 - 6, py2 - 6, px2 + 6, py2 + 6], fill="#a78bfa")
...
for i in range(0, 100, 6):
    ...
    y = py1 + t * (py2 - py1)
    if i % 12 < 6:
        draw.ellipse([x - 1, y - 1, x + 1, y + 1], fill="#6dc8ff")
...
# Title text
draw.text((70, 400), "Hermes vs Iron Claw", fill="white", font=font_title)
draw.text((70, 465), "Speed and Orchestration", fill="#94a3b8", font=font_subtitle)
draw.text((70, 505), "in Automation Agents", fill="#94a3b8", font=font_subtitle)
...
out_path = os.path.join(
    ...
    "public",
    "images",
    "hermes-vs-iron-claw-social.png",
)
